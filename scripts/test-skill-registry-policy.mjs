...
const evaluations = [
  { testCaseKey: "positif-1", kind: "positive", result: "pass" },
  { testCaseKey: "ambigu-1", kind: "ambiguous", result: "pass" },
  { testCaseKey: "interdit-1", kind: "forbidden", result: "pass" },
];
const candidate = {
...
test("requires positive, ambiguous and forbidden tests to pass", () => {
  const incomplete = validate({ evaluations: evaluations.slice(0, 2) });
