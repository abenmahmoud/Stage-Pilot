...
- adresse IP, hôte local, identifiants, paramètres et fragment sont refusés ;
...
`npm run test:communication-webmail-client` couvre dix scénarios : réussite,
requête exacte, configuration dangereuse, réponses invalides, statut HTTP,
commande ou reçu altéré, délai, lot de 200 livraisons et bornes du worker.
