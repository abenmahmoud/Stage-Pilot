...
Publication T073 confirmée le 10 septembre 2026 à 21:11:29 UTC : /chromebook sur le domaine principal, commit fonctionnel 4f333c4, déploiement READY dpl_FHb1HBvR4kTXAsTcEosYkEHcM4qQ. Deux alias affectés explicitement après recette immuable. Domaine principal vérifié : 29 réponses partagées page/chat, parcours mobile, réponses serveur distribution/QR/SAV sans compte ni formulaire forcé. Build et gate complets passés ; aucun envoi ni création de dossier. Rapports et captures dans Distribution_ordinateurs_2026-09/tmp/qa-chromebook-live. Communication corrigée prête hors dépôt ; organisation grande salle à confirmer avec le prestataire. Le commit documentaire de clôture ne modifie pas le code déployé.

## 10 septembre 2026 — Harmonisation autour de l’accueil (002/T074)
Adel demande de mettre en ligne la présentation commune avant l’envoi aux secondes et parents. Il confirme que la Région et la grande salle sont organisées pour les 14 et 15 septembre ; ne pas relancer cette question. Cadre public partagé entre portail, articles et guide Chromebook ; charte basée sur l’accueil, bleu/bleu nuit, même portrait, navigation mobile commune, préparation compacte et recherche du guide. Connexion et cadre de gestion reprennent la même identité. Build, gate complet et 44 contrôles Chromium de pages/parcours sur quatre tailles réussis, sans mutation réelle. Publication à confirmer dans docs/operations/HARMONISATION_2026-09-10.md. Aucun changement des règles de l’agent ni reprise de l’EDT.
Publication T074 confirmée : commit fonctionnel c131561, déploiement READY dpl_5Mr613m12WsRRrn7c65oiEsqmwHS. Alias principal et alias de branche affectés explicitement après recette immuable. Domaine principal vérifié sur ordinateur et téléphone : cinq pages publiques, trois réponses serveur Chromebook et passage FAQ → chat. Zéro erreur JavaScript/console ; listes privées protégées. Aucun email, SMS, OTP, push ou dossier créé. Les tâches de traitement individuel et l’EDT restent hors de ce lot. Preuves : docs/operations/HARMONISATION_2026-09-10.md.

## 11 septembre 2026 — Crédit ESSUF et radio (002/T075)
Adel autorise la signature « Powered by ESSUF Group » liée à essuf.fr et souhaite valoriser le portail dans son portfolio ESSUF. Il indique l’accord de la proviseure pour une radio discrète, volume initial de 1 %, réglable. Crédit public ajouté ; lecteur global préparé avec lecture au clic, réglages repliables, gain Web Audio à 0,01, pause et arrêt sur les routes privées. Aucun flux ESSUF trouvé ou fourni : liste vide et lecteur masqué jusqu’à réception de l’URL. Build, gate et tests Chromium sur WAV fictif (ordinateur, 390 et 320 px) réussis. T075 reste ouverte pour le flux réel. Preuves : docs/operations/ESSUF_SIGNATURE_RADIO_2026-09-11.md ; passation pour l’agent essuf.fr hors dépôt dans ESSUF_SIGNATURE_RADIO_2026-09-10/PASSATION_SITE_ESSUF.md. Aucun envoi de communication.
Publication du crédit ESSUF confirmée le 11 septembre : code 2daf5f5, déploiement READY dpl_Da2ATPF1wdpgsGc12EgZ7NRoqdVz, deux alias affectés explicitement. Accueil, guide et aide vérifiés sur le domaine en ordinateur/téléphone, six états, zéro erreur JavaScript et zéro requête audio. Radio masquée en attente du lien demandé à Adel ; T075 reste ouverte. Aucune autre musique choisie. Preuves : docs/operations/ESSUF_SIGNATURE_RADIO_2026-09-11.md.

## 11 septembre 2026 — Accueil de bienvenue et mention radio (002/T075)
Précision d’Adel : l’entrée du site doit accueillir la personne, un clic doit démarrer la playlist ESSUF à 1 %, puis seule une petite mention « radio » ouvre les réglages. Accueil et commande visibles même avant réception du flux : cette décision remplace le masquage initial. Charte et photo du lycée conservées, pas de musique de substitution. Première entrée depuis l’accueil, aucun écran intermédiaire sur les liens d’aide/suivi/guide. Indicateur de visite de session sans donnée personnelle ; musique jamais restaurée automatiquement. Accueil réouvrable par /?bienvenue=1 et lien dans le lecteur. Hors lot : EDT, identités, notifications et demandes. Référence : docs/design/ACCUEIL_RADIO_2026-09-11.md ; preuves de publication dans docs/operations/ESSUF_SIGNATURE_RADIO_2026-09-11.md. T075 reste ouverte tant que le flux ESSUF réel n’est pas branché et vérifié.

## 11 septembre 2026 — Playlist Spotify ESSUF fournie (002/T075)
Adel transmet l’archive essuf-radio-player-handoff-2026-09-11.zip. Source réelle : playlist Spotify 2QHUYT3UGNRrO3F8xHHrZ6, Radio ESSUF — ASSMA & Pop française. Ce n’est pas un flux audio direct. Documentation Spotify contrôlée : aucun réglage de volume dans l’API iframe, donc 1 % non garanti ; différence expliquée à Adel. Branchement du lecteur officiel à la demande depuis « radio », entrée silencieuse, pas de faux curseur 1 %, aucun OAuth ni secret sur le lycée. Iframe global conservé entre pages publiques ; fermeture et routes privées l’arrêtent en le retirant. Consentement de chargement et lien de confidentialité, pas de requête Spotify avant clic, pas d’autoplay ni d’écoutes automatisées. Le flux direct reste à fournir pour la demande initiale à 1 % ; T075 reste ouverte. Détails : docs/operations/RADIO_SPOTIFY_2026-09-11.md ; preuves de recette/publication hors dépôt : BRANCHEMENT_SPOTIFY_2026-09-11. Source et administration ESSUF restent séparées du portail.

## 11 septembre 2026 — Retrait des invitations radio de la bienvenue (002/T075)
Adel demande de supprimer uniquement « Radio ESSUF vous accompagne, quand vous le souhaitez. » et « Découvrir la radio », et de laisser tout le reste. Ces deux éléments sont retirés de PublicPortalWelcome ; la commande radio du site et la playlist restent disponibles. Aucun changement de source musicale, de charte ou des services. Build réussi, recette navigateur locale en 1440 et 390 px réussie : invitation absente, entrée au lycée fonctionnelle, crédit ESSUF et commande radio conservés, aucune erreur JavaScript. Preuves hors Git dans BRANCHEMENT_SPOTIFY_2026-09-11/welcome-cleanup-* ; publication et contrôle distant à consigner au même endroit.

## 11 septembre 2026 — Calendrier relié aux actualités (002/T074B)
Publication terminée : commit fonctionnel 68d8dab, déploiement dpl_89zzHP3nRLHVEy9Qf5fbTzi1CUcf READY et domaine principal confirmé. Recette réelle 1440/390/320 sur URL immuable puis domaine : six rendez-vous, photos, dates, navigation et téléchargements ICS passent, sans erreur JavaScript ni débordement. Contrôles HTTP 200/400/404/401 attendus, trois articles toujours en brouillon. T074B close. Les limites navigateur/IA et la précision ASSMA encore attendue sont documentées.
Calendrier public créé dans la charte du lycée, lien menu/accueil/À la une, vues mois et liste, filtre par jour, photos et ICS. Dates portées par les snapshots des articles : publication humaine commune, aucun brouillon exposé. Atelier Hebdo et protocole Gmail préparent les mêmes métadonnées. Huit nouvelles versions et audits de projection des dates explicites ; cinq articles déjà publiés fournissent six rendez-vous, trois articles restent en brouillon. Textes inchangés, rejeu sans doublon. Build, gate, tests calendrier/hebdo et recette locale 1440/390/320 réussis ; édition testée avec API et identité fictives. Publication distante encore à vérifier. Détails : docs/operations/CALENDRIER_PUBLIC_2026-09-11.md. Allusion d’Adel à une fonction d’ASSMA en attente de précision ; pas de modification de la radio.

## 11 septembre 2026 — Actualités illustrées et accès accueil (002/T074A)
Publication terminée : commit 9dea25d, déploiement dpl_FoPgyqdwVJxeJLkwrb5dcuzXFM2j READY. URL immuable et domaine principal testés en 1440/390/320, six articles réellement publiés ; CTA, photos et pages individuelles passent, sans débordement ni erreur console. Captures relues. T074A close. Doublon public « Changement de spécialité… - copie » signalé, sans archivage automatique.
Demande d’Adel : petites photos adaptées aux articles, charte cohérente sur smartphone, aide à gauche et bouton À la une à droite de l’accueil. Implémenté : six photographies d’illustration locales optimisées, couverture éditeur prioritaire, sélection thématique automatique pour les futures actualités, photos dans le flux et les pages individuelles, aperçu administratif partagé. Recette locale 1440/390/320 avec huit articles et six thèmes réussie ; build, gate sécurité et intégrité Spec Kit réussis. Pas de publication de brouillon, de notification ni modification de droits. Détails et suite distante : docs/operations/ACTUALITES_VISUELLES_2026-09-11.md.

## 11 septembre 2026 — Hebdo reçu par Gmail, préparation récurrente (002/T071H)
Compte Gmail indiqué par Adel confirmé via le profil connecté. Hebdos des 7 et 14 septembre retrouvés auprès de l’adresse officielle du lycée. Dernier PDF entièrement lu et rendu : deux pages, dont une blanche. Huit propositions corrigées et sourcées préparées hors Git dans Hebdos_lycee, avec aperçu 1280/390 px vérifié. Contrôle Codex hebdomadaire actif vendredi 18 h 30, automatisation pr-parer-l-hebdo-du-lyc-e ; pas de publication ni notification aux familles. Accès retrouvé via list_branches : xijocumlwivhbmffrnlj est la branche guichet-lycee-preview du parent lyceegest sfqhxiamhgsbbogluqtq. Huit brouillons, huit versions et huit audits insérés par execute_sql autorisé ; deux rejeux sans doublon, aucun contenu publié. Administration accessible aux comptes habilités via /admin/contenus ; API publique vérifiée sans exposition du brouillon. Le suivi récurrent dépose désormais les brouillons, avec validation humaine avant publication et mise à jour de l’agent. Aucune modification de droits ou secret nécessaire. Nouvelle heure 17 h 30 pour la rencontre des parents du 22 septembre proposée à validation, site non modifié. Protocole, état privé, preuves et limites : docs/operations/HEBDO_GMAIL_2026-09-11.md.

## 11 septembre 2026 — Accueil personnel (002/T074C)
Accueil Pour moi, aujourd’hui publié : session OTP existante, cours aujourd’hui/demain et impression/PDF, enfants issus des liens autorisés, aperçu limité aux demandes liées côté serveur à l’identité et au suivi de l’appareil. Les anciennes demandes restent dans le suivi, sans rapprochement par nom. Aucune donnée personnelle persistée par le nouveau bloc ; effacement arrière-plan, expiration, changement d’identité et hors connexion. Build et gate réussis, 13 tests dédiés et parcours fictifs 1440/390/320 avec choix du contact, OTP unique simulé, reprise et ouverture de document réussis. Version 6480144 puis correctif db5a199 publiés ; déploiement final dpl_AHYpQXkNpWZkvXUNZWwUQUd2wmsT READY, domaine principal confirmé et recette publique sur les deux adresses réussie dans les trois formats. Aucun OTP réel ni communication envoyé pour les tests. T074C close. Preuves et limites : docs/operations/ACCUEIL_PERSONNEL_2026-09-11.md.

## 12 septembre 2026 — Informations personnelles ciblées (002/T074D)
Priorité demandée par Adel : relier les publications validées aux profils et classes de l’annuaire. Implémentation : choix explicite élèves/parents/personnels, classes agrégées de l’import actif, ciblage conservé dans les versions, lecture protégée dans l’accueil personnel, article complet, documents propres et export des mêmes dates validées. Aucun ciblage nominatif deviné, aucun envoi automatique, aucun contenu réservé remis au modèle. Le calendrier public et les archives excluent les informations réservées. Les notifications ciblées et le rappel conversationnel de ces articles restent des lots distincts.
Recette locale : 11 tests dédiés, 13 tests de l’accueil personnel, build et gate complets réussis ; parcours fictifs 1440/390/320 avec lecture, document, calendrier, choix d’enfant, retrait d’article, anonymat et expiration. Éditeur 1440/390 : élèves + parents, classe choisie, refus de publier avant enregistrement, relecture puis publication simulée. Correction du message de confirmation effacé par le rechargement ; publication protégée contre un changement concurrent de version. Trois requêtes compilées avec Drizzle et EXPLAIN distant en lecture seule, périmètre mono-établissement confirmé par compteurs. Aucun OTP, email, SMS, push, dossier ou article réel créé. Livraison distante à compléter dans docs/operations/INFOS_PERSONNELLES_2026-09-12.md.
Livraison confirmée : version 9cf78d3, déploiement dpl_9q6TrBxwbCwpGpuuzycdHb2fFzuw READY. URL immuable et domaine principal vérifiés en lecture seule en 1440/390/320 px ; neuf réponses HTTP attendues, aucune écriture ni erreur JavaScript. T074D close. Notifications ciblées et rappel conversationnel des articles réservés demeurent explicitement hors de ce lot.

## 12 septembre 2026 — Supervision des fichiers rétablie (003/T009C2A)
Capture d’Adel : panneau des contrôles indisponible. Journaux Vercel : postgres-js refuse un Date passé sans encodeur dans du SQL brut. Correction du seuil en ISO UTC/timestamptz et décodage des agrégats min/max via les colonnes Drizzle. Régression reproduite puis huit tests dédiés réussis, build et gate complets réussis ; recette locale 1440/390 avec actualisation après panne, brouillon conservé et rappel historique visible. Lecture SQL distante agrégée : 78 fichiers WordPress, aucun fichier nouvellement en attente ni bloqué/en erreur ; les 78 restent à rescanner. Aucune modification de ces fichiers ou du worker.
cc86f33 déployé READY, dpl_7GVFoTbdF3KJjvQqGq9LYg7JWXuj, domaine principal confirmé. Contrôles HTTP publics et refus anonyme réussis sur URL immuable et domaine. Pas de session éditeur réelle accessible dans le navigateur connecté : recette authentifiée locale seulement, confirmation visuelle distante au prochain rafraîchissement d’Adel. T009C2A close, exploitation antivirus T009C toujours ouverte. Preuves : docs/operations/CONTROLE_FICHIERS_2026-09-12.md.


## 12 septembre 2026 — push et flash : recette et raccordement

Adel autorise la poursuite sur le poste et demande les notifications push/flash. Lot 002/T068A et correctif T071G : classes réelles, accès identifié, abonnement explicite, historique de versions préservé et publication de correction sans renvoi automatique. Routes et worker vérifiés sur PostgreSQL jetable ; navigateur 1440/390 px, aucun envoi réel. Migrations additives appliquées sur la base pilote et worker de minute en minute vérifié sur le VPS. Frontend à contrôler après le push Git. Compte rendu : `docs/operations/PUSH_FLASH_2026-09-12.md`. Ne pas annoncer une réception physique sur téléphone ni l’email/SMS flash : pas encore éprouvés/activés. Le rescannage des 78 fichiers historiques reste à faire.

Mise en ligne confirmée : commit c9d35b8, déploiement `dpl_13GUi2yxXhUFc4kNpRz2huKn3G5H` READY et domaine principal sur cette version. Quatorze contrôles HTTP réussis. T068A et T071G clos ; T068B reste ouvert pour une réception physique avec Adel. Module email/SMS flash toujours désactivé. Conteneur de recette, volume et tunnel retirés ; worker serveur vérifié sans erreur.

## 16 septembre 2026 — Croisement personnel des données (002/T069D)
Adel demande une liste privée des enseignants sans codes et un onglet superadmin pour les informations croisées au fil des imports. Classeur hors Git : 24 enseignants sans KOXO et 9 présences à confirmer, aucune valeur de code. Onglet `/gestion/donnees` : annuaire actif, attributs ENT autorisés, disponibilité du coffre, index EDT et matières approuvées, relations familiales/pédagogiques, filtres qualité et export de la page. Accès superadmin/MFA, aucune fusion floue, aucun modèle alimenté avec les secrets. Sources et limites visibles, ajout d’un article au manuel. SIECLE annoncé encore attendu. Recette et publication dans `docs/operations/DONNEES_CROISEES_2026-09-16.md`.

Livré et vérifié sur le domaine principal : commit e4b3187, déploiement dpl_hkQYqx4kX63vHzJY4Fwv8oF4bsz6 READY. Recette superadmin réelle : 4 518 personnes, fiche d’Adel avec EDT relié, quatre libellés de matières et cinq relations pédagogiques. Liste Excel privée de 33 enseignants livrée, sans codes ; sept fiches enrichies par des cours EDT dans une colonne séparée, 16 disciplines administratives laissées non renseignées. Raccourci Documents « Depot SIECLE - Lycee Blaise Cendrars » créé vers le dépôt privé. T069D clos ; SIECLE et la remise KOXO réelle après OTP restent à traiter. Build et contrôles ciblés réussis ; la suite générale conserve deux échecs historiques non modifiés dans test-assistant-school-context.mjs.

## 16 septembre 2026 — SAV numérique régional (002/T073A)
Adel fournit le pack `SAV-numerique-rentree-2026.zip` et demande un parcours sur le site, un email à transmettre lui-même et une répartition claire des rôles. Page `/assistance-numerique` : deux chemins UNOWHY/ASUS, liens officiels, aide du chat, différence coordination régionale/RRUPN. Questions UNOWHY et « SAV La Poste » orientées vers la réponse publique, dossiers locaux catégorie ordinateur vers la file `referent_numerique`. La lettre de mission fournie est un formulaire non signé ; ne pas publier de rémunération ni attribuer formellement le rôle à une personne depuis ce seul document. Créneaux et réception locale des appareils à décider avec la direction. Email TXT/HTML hors Git dans `outputs/sav-numerique-2026-09-16/`, aucun envoi effectué. Commits `f664ab45` et `5f46daa6` publiés, déploiement final `dpl_3otduqyG8u58WJaR2se4n1nKk5My` READY ; recette domaine principal, bureau/mobile, build et tests ciblés documentés dans `docs/operations/SAV_NUMERIQUE_2026-09-16.md`. T073A clos.

## 16 septembre 2026 — Contrôle du nouvel export KOXO des professeurs (002/T069C)
`Professeurs.XML` fourni par Adel comparé en lecture seule au pack précédent : 165 comptes et mots de passe XML renseignés, 164 identifiants déjà présents dans le pack, dont les 98 enseignants avec KOXO. Les 24 enseignants sans KOXO restent sans correspondance nominative exacte. Un compte supplémentaire homonyme d'un enseignant déjà doté a un identifiant différent ; pas d'attribution automatique. Les neuf attributions retenues restent à confirmer avec le dernier export ENT, et une remise réelle après OTP reste à constater. Dans le précédent pack ENT, les 122 enseignants ont un email mais huit seulement un téléphone, dont un seul parmi les 89 déjà importés. Les valeurs XML encodées ne prouvent pas un mot de passe fonctionnel ; aucun remplacement, import ou envoi n'a été effectué. Rapport nominatif privé sans code sous `outputs/croisement-2026-09-16/`; synthèse sans identité dans `docs/operations/IMPORT_KOXO_2026-09-16.md`. T069C reste ouverte.

## 18 septembre 2026 — reprise de la file des demandes
Constat : 47 dossiers sur 30 jours, 46 ouverts, principalement ENT (24). Le chat sait guider vers l'accès ENT personnel après OTP, mais les anciens dossiers ne se fermaient pas après résolution et les réponses proposées restaient parfois génériques. Correctif préparé : confirmation explicite de résolution dans le dossier, réouverture du même dossier par nouveau message, suggestions ENT/EDT/PRONOTE ciblées sans code. Aucune attribution nominative des anciens dossiers ni campagne envoyée automatiquement. Voir `docs/operations/FILE_DEMANDES_ENT_2026-09-18.md` pour la recette et l'état de publication.
Web en ligne sur le domaine officiel via `1ace62e` / `dpl_EaGBw8poifMuSAa6A4PzNKEtHEU9` READY. Worker email VPS mis à jour avec le même commit, empreinte et timer contrôlés. Les nouveaux accusés de réception ENT indiquent le parcours dans le même dossier ; les anciens dossiers attendent encore une reprise ciblée.
Suite : le suivi des anciens dossiers ENT et EDT appelle désormais le même assistant dans le dossier, avec réponses temporaires après OTP et renvoi vers le fil existant si une reprise humaine est nécessaire. Ne pas dire que cette fonction notifie d'elle-même les 47 demandeurs : elle agit lorsqu'une personne ouvre son dossier.

## 20 septembre 2026 — hebdo publié et préparation de la rencontre des parents
Adel autorise la mise en ligne de l’hebdo du 21 au 25 septembre et prépare un nouvel export ENT avant la présentation aux parents du mardi 22 septembre. Trois actualités ont été publiées avec audit : rencontre des parents, certificats de scolarité et vacances d’automne. L’ancien brouillon à 17 h 30 est archivé. Horaire validé partagé par l’accueil et Blaise : salle polyvalente 17 h 50–18 h 10, puis professeurs principaux 18 h 10–19 h. Aucun email, SMS ou push envoyé par cette publication.

État de préparation : import actif du 17 septembre avec 6 980 lignes valides, 4 550 personnes et 2 430 relations ; coffre avec 1 306 attributions ENT et 98 KOXO disponibles. Sur sept jours : 13 identités vérifiées ; les autres essais sont expirés, dont 35 personnes non trouvées, une ambiguïté, 31 abandons/expirations avant choix du contact, 22 échecs et 4 codes non saisis à temps. Ce n’est pas une file active bloquée. La messagerie compte 69 envois réussis et aucun job définitivement échoué non repris. Il reste 50 dossiers ouverts, dont 47 depuis plus de 48 heures : ne pas promettre leur clôture automatique. Raccourci privé créé dans Documents : `DEPOT_ENT_A_METTRE_A_JOUR`, pointant vers le dépôt ENT hors Git. Le prochain CSV doit être contrôlé et activé avant usage. Procédure et démonstration : `docs/operations/PREPARATION_RENCONTRE_PARENTS_2026-09-22.md`.

## 20 septembre 2026 — annuaire ENT, attributs et coffre actualisés
