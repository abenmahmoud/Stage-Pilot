...
- [ ] T074C Créer l’accueil « Pour moi, aujourd’hui » : session OTP existante, cours aujourd’hui/demain selon le périmètre autorisé, aperçu des demandes liées à l’identité et documents disponibles, accès direct au chat et au suivi. Conserver les rendez-vous publics communs et la publication humaine des informations. Vérifier ordinateur/téléphone, expiration, changement de personne et absence de source. Preuves : docs/operations/ACCUEIL_PERSONNEL_2026-09-11.md.
