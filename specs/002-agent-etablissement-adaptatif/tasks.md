...
- [ ] T075 Ajouter le crédit lié « Powered by ESSUF Group » et mettre en service une radio ESSUF discrète à volume initial de 1 %. Crédit et lecteur développés ; accueil de bienvenue au clic et petit mot « radio » visibles même sans source, selon la précision d’Adel du 11 septembre. Recette native sur audio fictif ; source réelle encore attendue. Ne pas activer de musique de substitution. Détails et branchement : docs/operations/ESSUF_SIGNATURE_RADIO_2026-09-11.md ; référence visuelle : docs/design/ACCUEIL_RADIO_2026-09-11.md.
