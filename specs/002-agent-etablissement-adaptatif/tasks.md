...
- [x] T010B4B1 Corriger l’historique du chat après OTP : reprise de la question
  ...
  8 parcours navigateur réussis localement puis sur le bundle publié, avec API
...
- [x] T049C9A Activer le budget commun des cinq points d’appel OpenAI, ajuster les réservations à la consommation mesurée et fournir une supervision superadmin. Configuration initiale 1 € estimé/jour, 0,04 €/réservation, tarifs et change vérifiés. Concurrence PostgreSQL isolée et droits serveur vérifiés; publié `15c725a`, domaine READY, appel IA réel et clôture du coût confirmés. Le budget/les alertes du compte fournisseur restent distincts. Rapport GESTION_PRIVEE_BUDGET_2026-09-12.
...
- [ ] T066C2 Relier les exports officiels et le profil vérifié aux réponses du chat :
  ...
  Publié `fe64ce0`, déploiement `dpl_GGLNEVmffKu9P2kMAawX1bHabT6c` READY,
  domaine vérifié et accès anonyme à la nouvelle API refusé (401).
  ...
  Publié `8a417cd`, déploiement `dpl_DPSYC5TobmKsq69guaaiktacgToN` READY,
  domaine et restrictions anonymes vérifiés le 13/09 à 15:53 Paris.
...
- [x] T069D Fournir la liste privée sans codes et l’onglet superadmin Données
...
- [ ] T073A Publier une page SAV numérique distinguant PC UNOWHY et Chromebook ASUS, relier les réponses du chat et la file du service numérique, documenter le rôle de la coordination et préparer un email aux personnels. Preuves : `docs/operations/SAV_NUMERIQUE_2026-09-16.md`. L’envoi du message et la désignation locale de la personne chargée des retours restent distincts.
...
- [ ] T075 Ajouter le crédit lié « Powered by ESSUF Group » et mettre en service une radio ESSUF discrète à volume initial de 1 %. Crédit et accueil de bienvenue développés. Playlist Spotify fournie le 11 septembre et lecteur officiel intégré au clic ; aucune commande 1 % disponible dans cet iframe. Entrée silencieuse avec ce lecteur, pas de musique de substitution. Le flux direct reste attendu pour l’ambiance exacte à 1 %. Recettes et limites : docs/operations/RADIO_SPOTIFY_2026-09-11.md ; historique : docs/operations/ESSUF_SIGNATURE_RADIO_2026-09-11.md ; charte : docs/design/ACCUEIL_RADIO_2026-09-11.md.
...
- [x] T074A Illustrer les articles avec des photographies cohérentes et ajouter l’accès « À la une » à droite de l’aide sur l’accueil. Collection de six thèmes, couverture de l’éditeur prioritaire, aperçu administratif commun et adaptation mobile. Commit 9dea25d publié et vérifié sur URL immuable puis domaine principal en 1440/390/320 px, six articles réels, navigation et images fonctionnelles. Preuves : docs/operations/ACTUALITES_VISUELLES_2026-09-11.md.
- [x] T074B Relier un calendrier public mobile aux versions publiées des actualités et de l’hebdo : dates explicites, photos, accueil, consultation par mois/jour, téléchargement ICS, édition et publication commune. Commit 68d8dab, déploiement READY, recette réelle sur URL immuable puis domaine principal en 1440/390/320 px, six rendez-vous et téléchargements vérifiés, brouillons non exposés. Preuves et limites : docs/operations/CALENDRIER_PUBLIC_2026-09-11.md.
...
- [x] T074E Séparer la gestion privée `/gestion` de l’espace stages et retirer l’entrée agent des pages publiques, avec menus par rôles et anciennes adresses redirigées. Douze parcours fictifs mobile/bureau et gardes serveur vérifiés; publié `15c725a`, six contrôles réels sur l’URL immuable et le domaine principal réussis. Rapport GESTION_PRIVEE_BUDGET_2026-09-12.
- [x] T074F Ajouter le manuel du superadmin `/gestion/manuel` : 27 fiches avec démarches, prérequis, limites, recherche, filtres et liens directs. Compilation, 17 contrôles de sécurité/navigation et dix parcours fictifs 1440/390/320 px réussis. Publié `d6f3f5e`, domaine principal et URL immuable vérifiés, accès visiteur refusé. Rapport MANUEL_SUPERADMIN_2026-09-12.
