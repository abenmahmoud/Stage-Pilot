...
comment on function public.agent_validate_approval_transition() is
  'Protects immutable A3 approvals and permits only unconsumed approved approvals to expire after their deadline.';
