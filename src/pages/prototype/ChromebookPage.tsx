    ...
    <PublicPortalShell view="services" className="cb-page">
      <div id="chromebook-main" className="cb-main">
        ...
        <section className="cb-help" aria-label="Besoin d’accompagnement">
          ...
          <div className="cb-help-card cb-help-card-light"><LifeBuoy aria-hidden="true" /><h2>Le bon service de réparation</h2><p>Le parcours dépend de l’appareil : Chromebook ASUS ou ancien PC UNOWHY. Retrouvez les deux démarches au même endroit.</p><Link to="/assistance-numerique">Choisir mon parcours SAV <ArrowUpRight aria-hidden="true" /></Link><a href={CHROMEBOOK_PORTAL} target="_blank" rel="noreferrer">Ouvrir le portail régional <ExternalLink aria-hidden="true" /></a><a className="cb-poster-link" href="/chromebook/affiche-region.jpg" target="_blank" rel="noreferrer">Voir l’affiche MonOrdi IdF et ses QR codes <ExternalLink aria-hidden="true" /></a></div>
        </section>
