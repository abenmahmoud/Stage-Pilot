...
export const MANUAL_ARTICLES: ManualArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Pour iCal, utilisez Activer les calendriers validés après contrôle de l’aperçu, puis confirmez ACTIVER. Les calendriers non traités restent en attente et modifiables dans l’import d’origine. Après de nouveaux rattachements, le même bouton publie la mise à jour sans retirer les calendriers déjà disponibles. Pour une version entièrement vérifiée, Approuver puis Activer reste disponible.",
