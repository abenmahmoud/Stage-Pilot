...
export const MANUAL_ARTICLES: ManualArticle[] = [
  ...
  },
  {
    ...
    steps: [
      "Ouvrez Annuaire du lycée. Consultez le modèle fictif pour vérifier les colonnes attendues.",
      "Choisissez le CSV ou Excel, ajoutez le rapport de vérification demandé et renseignez le nom de version, l’origine et l’usage autorisé.",
      ...
      "Vérifiez une recherche autorisée et un parcours d’identité. Conservez les contacts officiels et les identifiants exacts, y compris leurs chiffres éventuels.",
    ],
