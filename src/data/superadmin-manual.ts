...
export const MANUAL_ARTICLES: ManualArticle[] = [
  ...
  },
  {
    ...
    prerequisite: "Les feuilles remises par l’administration. Un « A » non effacé ou une mention « Absent » lisible signale un élève à vérifier ; relisez aussi le nom et la classe avant la saisie.",
    steps: [
      ...
      "Avant de convoquer les absents, confirmez avec la Région ou La Poste qui effectue le scan du QR code MonOrdi IdF lors d’une remise différée. Ce suivi du lycée ne réalise pas l’affectation régionale.",
      "Lorsqu’un élève vient récupérer son ordinateur, recherchez son nom, vérifiez son identité et son colis nominatif selon la procédure confirmée.",
      "Appuyez sur Marquer remis après la remise effective du PC. La date et le compte ayant effectué l’action sont enregistrés dans le suivi interne du lycée.",
    ...
    check: "Un élève déjà présent dans la même classe n’est pas ajouté une seconde fois. Ne déduisez pas les absences de la date d’impression : contrôlez les « A » non effacés, les mentions « Absent » et la classe sur chaque page. Ce suivi ne remplace pas la vérification d’identité, l’affectation régionale ni les documents officiels de la Région.",
